...
// Ensure IPv4 preferred for local container routing if needed
...
7. Conserva tus respuestas en un tamaño moderado (generalmente 2 a 3 párrafos de prosa pulida) para que la lectura sea fluida en el panel de diálogo del aula.`;
    ...
    // Map history to standard @google/genai contents
    ...
    // Build the contextualized user prompt
...
async function initServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`[Aula Masónica] Servidor iniciado satisfactoriamente en http://localhost:${PORT}`);
  });
}
